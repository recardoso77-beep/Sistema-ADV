            ...
            {showCreateFirmForm ? (
              ...
              <div className="bg-white border border-indigo-100 rounded-2xl p-5 shadow-sm space-y-4 animate-fade-in">
                ...
                <form onSubmit={handleUpdateFirm} className="space-y-4 text-xs">
                  ...
                  {/* GED / Armazenamento em Nuvem */}
                  <div className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
                    <span className="font-semibold text-slate-800 block text-[11px] uppercase tracking-wider">GED / Armazenamento em Nuvem</span>
                    <div>
                      <label className="block text-[10px] font-semibold text-slate-500 uppercase mb-1">Provedor de Nuvem</label>
                      <select
                        value={selectedFirm.cloud_provider || "none"}
                        onChange={(e) => setSelectedFirm({ ...selectedFirm, cloud_provider: e.target.value as any })}
                    ...
                    {selectedFirm.cloud_provider === "dropbox" && (
                      <div className="space-y-3 pt-2">
                        <div>
                          <label className="block text-[10px] font-semibold text-slate-500 uppercase mb-1">App Key (Client ID)</label>
                          <input
                            type="text"
                            value={selectedFirm.dropbox_client_id || ""}
                            onChange={(e) => setSelectedFirm({ ...selectedFirm, dropbox_client_id: e.target.value })}
                            placeholder="Ex: abcd1234efgh"
                            className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-slate-800 outline-none focus:border-indigo-500 font-mono"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-semibold text-slate-500 uppercase mb-1">App Secret (Client Secret)</label>
                          <input
                            type="password"
                            value={selectedFirm.dropbox_client_secret || ""}
                            onChange={(e) => setSelectedFirm({ ...selectedFirm, dropbox_client_secret: e.target.value })}
                            placeholder="••••••••••••••••"
                            className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-slate-800 outline-none focus:border-indigo-500 font-mono"
                          />
                        </div>
                    ...
                    {selectedFirm.cloud_provider === "gdrive" && (
                      <div className="space-y-3 pt-2">
                        <div>
                          <label className="block text-[10px] font-semibold text-slate-500 uppercase mb-1">Google Client ID</label>
                          <input
                            type="text"
                            value={selectedFirm.gdrive_client_id || ""}
                            onChange={(e) => setSelectedFirm({ ...selectedFirm, gdrive_client_id: e.target.value })}
                            placeholder="Ex: 123456-abcdef.apps.googleusercontent.com"
                            className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-slate-800 outline-none focus:border-indigo-500 font-mono"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-semibold text-slate-500 uppercase mb-1">Google Client Secret</label>
                          <input
                            type="password"
                            value={selectedFirm.gdrive_client_secret || ""}
                            onChange={(e) => setSelectedFirm({ ...selectedFirm, gdrive_client_secret: e.target.value })}
                            placeholder="••••••••••••••••"
                            className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-slate-800 outline-none focus:border-indigo-500 font-mono"
                          />
                        </div>
                    ...
                    {selectedFirm.cloud_provider === "onedrive" && (
                      <div className="space-y-3 pt-2">
                        <div>
                          <label className="block text-[10px] font-semibold text-slate-500 uppercase mb-1">OneDrive Client ID</label>
                          <input
                            type="text"
                            value={selectedFirm.onedrive_client_id || ""}
                            onChange={(e) => setSelectedFirm({ ...selectedFirm, onedrive_client_id: e.target.value })}
                            placeholder="Ex: 00000000-0000-0000-0000-000000000000"
                            className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-slate-800 outline-none focus:border-indigo-500 font-mono"
                          />
                        </div>
                        <div>
                          <label className="block text-[10px] font-semibold text-slate-500 uppercase mb-1">OneDrive Client Secret</label>
                          <input
                            type="password"
                            value={selectedFirm.onedrive_client_secret || ""}
                            onChange={(e) => setSelectedFirm({ ...selectedFirm, onedrive_client_secret: e.target.value })}
                            placeholder="••••••••••••••••"
                            className="w-full bg-white border border-slate-200 rounded-xl px-3 py-2 text-slate-800 outline-none focus:border-indigo-500 font-mono"
                          />
                        </div>
